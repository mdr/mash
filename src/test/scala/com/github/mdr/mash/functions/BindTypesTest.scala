...
class BindTypesTest extends FlatSpec with Matchers {
  ...
  "A single positional argument" should "be tied to its parameter" in {
    val param = Parameter(Some("param"), "test param")
  ...
  "Multiple positional arguments" should "be tied to ordinary positional parameters" in {
    val param1 = Parameter(Some("param1"), "test param")
    val param2 = Parameter(Some("param2"), "test param")
    val param3 = Parameter(Some("param3"), "test param")
  ...
  "Multiple positional arguments" should "be tied to a single variadic parameter" in {
    val param = Parameter(Some("param"), "test param", isVariadic = true)
  ...
  "Extra positional arguments" should "be tied to a single variadic parameter" in {
    val param1 = Parameter(Some("param1"), "test param")
    val param2 = Parameter(Some("param2"), "test param", isVariadic = true)
  ...
  "Last arguments" should "be tied to the last parameter with variadics" in {
    val param1 = Parameter(Some("param1"), "test param", isVariadic = true)
    val param2 = Parameter(Some("param2"), "test param", isLast = true)
  ...
  "Last arguments" should "be tied to the last parameter with optionals" in {
    val param1 = Parameter(Some("param1"), "test param", defaultValueGeneratorOpt = Some(() ⇒ MashBoolean.True))
    val param2 = Parameter(Some("param2"), "test param", isLast = true)
  ...
  "All the features" should "work together" in {
    val optionalParam = Parameter(Some("optional"), "test param", defaultValueGeneratorOpt = Some(() ⇒ MashBoolean.True))
    val variadicParam = Parameter(Some("variadic"), "test param", isVariadic = true)
    val lastParam = Parameter(Some("last"), "test param", isLast = true)
    val positionalParam = Parameter(Some("positional"), "test param")
    val namedParam = Parameter(Some("named"), "test param", isFlag = true)
