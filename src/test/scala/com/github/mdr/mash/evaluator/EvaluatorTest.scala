...
class EvaluatorTest extends AbstractEvaluatorTest {
  ...
  "['foo', 'bar', 'baz'].grep -n 'b'" shouldEvaluateTo "['foo']"
  ...
  "max [] --default=0" shouldEvaluateTo "0"
  "[].max --default=0" shouldEvaluateTo "0"
  ...
  "maxBy length [] --default=0" shouldEvaluateTo "0"
  "[].maxBy length --default=0" shouldEvaluateTo "0"
  ...
  "{ foo: 42 } - []" shouldEvaluateTo "{ foo: 42 }"
  "{ foo: 1, bar: 2, baz: 3 } - ['baz', 'foo']" shouldEvaluateTo "{ bar: 2 }"
  "{ foo: 1, bar: 2, baz: 3 } - ['baz', 'foo', 'notInObject']" shouldEvaluateTo "{ bar: 2 }"
